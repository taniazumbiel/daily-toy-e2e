...
module.exports = {
    ...
    "@tags": ["test"],
    "Two participants video call e2e toy test"(browser) {
        ...
        .waitForElementVisible(readyToJoinHeader, 2000, "User successfully navigated to pre-join page and 'Ready to join?' question is displayed")
